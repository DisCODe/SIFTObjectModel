...
/*!
 * \class LUMGenerator
 * \brief LUMGenerator processor class.
 *
 * LUMGenerator processor.
 */
class LUMGenerator: public Base::Component,SIFTObjectModelFactory {
public:
	/*!
	 * Constructor.
	 */
    LUMGenerator(const std::string & name = "LUMGenerator");

	/*!
	 * Destructor
	 */
    virtual ~LUMGenerator();
...
//	Base::DataStreamOut<LUMGenerator> out_Trigger;
 ...
 */
REGISTER_COMPONENT("LUMGenerator", Processors::LUMGenerator::LUMGenerator)

#endif /* LUMGENERATOR_HPP_ */
